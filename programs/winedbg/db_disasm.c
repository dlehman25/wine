...
/*f3*/	{ "psllq",  TRUE, NONE,	 op2(EMX, MX),   0 },
/*f4*/	{ "(bad)",  FALSE,NONE,	 0,   0 },
/*f5*/	{ "pmaddwd",TRUE, NONE,	 op2(EMX, MX),   0 },
/*f6*/	{ "psadbw", TRUE, NONE,	 op2(EMX, MX),   0 },
/*f7*/	{ "maskmovq",TRUE,NONE,	 op2(EMX, MX),   0 },
/*f8*/	{ "psubb",  TRUE, NONE,	 op2(EMX, MX),   0 },
/*f9*/	{ "psubw",  TRUE, NONE,	 op2(EMX, MX),   0 },
/*fa*/	{ "psubd",  TRUE, NONE,	 op2(EMX, MX),   0 },
/*fb*/	{ "(bad)",  FALSE,NONE,	 0,   0 },
/*fc*/	{ "paddb",  TRUE, NONE,	 op2(EMX, MX),   0 },
/*fd*/	{ "paddw",  TRUE, NONE,	 op2(EMX, MX),   0 },
/*fe*/	{ "paddd",  TRUE, NONE,	 op2(EMX, MX),   0 },
