...
static const char str_EAGAIN[]          = "resource unavailable try again";
static const char str_ENOMEM[]          = "not enough memory";
...
static const char str_EDEADLK[]         = "resource deadlock would occur";
