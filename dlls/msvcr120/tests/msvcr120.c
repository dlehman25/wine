...
static void test_cexpf(void)
{
    static const struct {
        ...
        {      0.0f, -INFINITY,       NAN,       NAN, EDOM, TRUE, TRUE, FALSE, TRUE },
        {     -0.0f, -INFINITY,       NAN,       NAN, EDOM, TRUE, TRUE, FALSE, TRUE },
        {    100.0f,  INFINITY,       NAN,       NAN, EDOM, TRUE, TRUE, TRUE        },
        {   -100.0f,  INFINITY,       NAN,       NAN, EDOM, TRUE, TRUE, TRUE        },
        {    100.0f, -INFINITY,       NAN,       NAN, EDOM, TRUE, TRUE, TRUE        },
        {   -100.0f, -INFINITY,       NAN,       NAN, EDOM, TRUE, TRUE, TRUE        },
        ...
        {       NAN,     -0.0f,       NAN,     -0.0f                                },
        {       NAN,      1.0f,       NAN,       NAN                                },
        {       NAN,  INFINITY,       NAN,       NAN,    0, TRUE, TRUE, TRUE        },
        {      0.0f,       NAN,       NAN,       NAN                                },
        {      1.0f,       NAN,       NAN,       NAN                                },
        {       NAN,       NAN,       NAN,       NAN                                },
    };
    ...
    for(i=0; i<ARRAY_SIZE(tests2); i++) {
        errno = 0;
        exception.type = -1;
        c = _FCbuild(tests2[i].r, tests2[i].i);
        r = cexpf(c);
        e = errno;
        ok(compare_float(r._Val[0], tests2[i].rexp, 7), "expected %0.7e, got %0.7e for real %d\n", tests2[i].rexp, r._Val[0], i);
