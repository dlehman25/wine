...
extern HRESULT get_system_fontcollection(IDWriteFactory7 *factory, DWRITE_FONT_FAMILY_MODEL model, IDWriteFontCollection3 **collection) DECLSPEC_HIDDEN;
...
extern HRESULT create_font_collection_from_set(IDWriteFactory7 *factory, IDWriteFontSet *fontset, DWRITE_FONT_FAMILY_MODEL model,
       IDWriteFontCollection2 **collection) DECLSPEC_HIDDEN;
